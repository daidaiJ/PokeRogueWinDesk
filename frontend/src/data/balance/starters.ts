...
export const POKERUS_STARTER_COUNT = 10;
...
const starterCandyCosts: { passive: number; costReduction: [number, number]; egg: number; }[] = [
  { passive: 4, costReduction: [2, 6], egg: 3 }, // 1 Cost
  { passive: 4, costReduction: [2, 6], egg: 3 }, // 2 Cost
  { passive: 3, costReduction: [2, 5], egg: 2 }, // 3 Cost
  { passive: 3, costReduction: [1, 4], egg: 2 }, // 4 Cost
  { passive: 2, costReduction: [1, 3], egg: 1 }, // 5 Cost
  { passive: 2, costReduction: [1, 3], egg: 1 }, // 6 Cost
  { passive: 1, costReduction: [1, 2], egg: 1 }, // 7 Cost
  { passive: 1, costReduction: [1, 2], egg: 1 }, // 8 Cost
  { passive: 1, costReduction: [1, 2], egg: 1 }, // 9 Cost
  { passive: 1, costReduction: [1, 2], egg: 1 }, // 10 Cost
];
